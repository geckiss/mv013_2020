...
\fancyhead{}
\fancyhead[L]{Statistics for CS -- assignment 1} %%% change to your course name and change the number accordingly
...
\begin{titlepage}
    \begin{center}
        ...
        \Huge
          \textbf{Statistics for CS} %%% change to your course name
        ...
        Services - Systems, Modelling and Execution %%% change to your field of study
